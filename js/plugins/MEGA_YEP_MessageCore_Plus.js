//=============================================================================
// Yanfly Engine Plugins - Message Core, moding mega
// MEGA_YEP_MessageCore_Plus.js
//=============================================================================

var Imported = Imported || {};
Imported.MEGA_YEP_MessageCore_Plus = true;
...
Yanfly.Parameters = PluginManager.parameters('MEGA_YEP_MessageCore_Plus');
...
Window_Base.prototype.convertEscapeCharacters = function (text) {
    text = text.replace(/\[h2\](.*?)\[\/h2\]/g, function ($0, $1) {
        return '\\\{' + $1 + '\\\}'
    })
    text = text.replace(/\[h1\](.*?)\[\/h1\]/g, function ($0, $1) {
        return '\\\{' + $1 + '\\\}'
    })
    text = text.replace(/\[c=([0-9]+)\](.*?)\[\/c\]/g, function ($0, $1, $2) {
        return '\\\c[' + $1 + ']' + $2 + '\\\c[0]'
    })
...
Window_Message.prototype.convertNameBox = function (text) {
    text = text.replace(/^(.*?:)$/mgi, function () {
